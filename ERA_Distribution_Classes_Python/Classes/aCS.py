...
def aCS(N, old_lam, b, u_j, G_LSF):
    ...
    for k in range(1, Ns+1):
        ...
        geval[idx]   = G_LSF(u_jp1[idx,:])[0]   # JO: Error fix for the function above. Still don't understand why it does not work here but in the example paper files
        ...
        for t in range(1, Nchain[k-1]):
            ...
            if Ge <= b:
                ...
                geval[idx+t]   = Ge[0]     # JO: Error fix for the function above. Still don't understand why it does not work here but in the example paper files
