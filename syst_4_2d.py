...
V_range = np.linspace(0, 8.25, 20)
H_range = np.linspace(0, 3.9, 20)
...
for v in V_range:
    ...
    s.add_dist_load(e31, qz=v, local=True)
    s.add_dist_load(e32, qz=v, local=True)
    ...
    s.add_dist_load(e11, qz=h, local=True)
    s.add_dist_load(e12, qz=h, local=True)
    s.add_dist_load(e13, qz=h, local=True)
    s.add_dist_load(e14, qz=h, local=True)
